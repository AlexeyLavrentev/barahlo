...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      // UI-SPEC: scrim rgba(0,0,0,0.3) fade (no blur).
      className={cn(
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // UI-SPEC: 16px panel, hairline ring, scale 0.96→1 200ms ease-out,
          // enter and exit along the same path (apple-design §7).
...
function DialogFooter({
  ...
  return (
    <div
      ...
      // Plain footer row — no gray band (UI-SPEC dialog contract: fields +
      // footer buttons only).
      className={cn(
...
function DialogTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return (
    <DialogPrimitive.Title
      ...
      // UI-SPEC Heading role: 20/600, tight tracking (dialog titles).
      className={cn(
